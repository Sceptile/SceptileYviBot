    ...
    var basicBot = {
        ...
        commands: {
            ...
            cmddeletionCommand: {
                ...
                rank: 'user',
                type: 'startsWith',
              cookies: ['gives you a fortune cookie. It reads "You cannot love life until you live the life you love." ',
                    'gives you a fortune cookie. It reads "You will become great if you believe in yourself." ',
                    'gives you a fortune cookie. It reads "You must try, or hate yourself for not trying." ',
                    'gives you a fortune cookie. It reads "You can make your own happiness." ',
                    'gives you a fortune cookie. It reads "The greatest risk is not taking one." ',
                    'gives you a fortune cookie. It reads "A short stranger will soon enter your life with blessings to share." ',
                    'gives you a fortune cookie. It reads "Now is the time to try something new." ',
                    'gives you a fortune cookie. It reads "You are very talented in many ways." ',
                    'gives you a fortune cookie. It reads "You will travel to many exotic places in your lifetime." ',
                    'gives you a fortune cookie. It reads "Everyone agrees. You are the best." ',
                    'gives you a fortune cookie. It reads "Its better to be alone sometimes" ',
                    'gives you a fortune cookie. It reads "A journey of a thousand miles begins with a single step." ',
                    'gives you a fortune cookie. It reads "Sometimes you just need to lay on the floor." ',
                    'gives you a fortune cookie. It reads "Never give up. Always find a reason to keep trying." ',
                    'gives you a fortune cookie. It reads "Stop wishing. Start doing." ',
                    'gives you a fortune cookie. It reads "When hungry, order more Chinese food." ',
                    'gives you a fortune cookie. It reads "You have a deep interest in all that is artistic." ',
                    'gives you a fortune cookie. It reads "Your emotional nature is strong and sensitive." ',
                    'gives you a fortune cookie. It reads "To be old and wise, you must first be young and stupid." ',
                    'gives you a fortune cookie. It reads "If you are afraid to shake the dice, you will never throw a six." ',
                    'gives you a fortune cookie. It reads "Your life will be filled with magical moments." ',
...
'gives you a high five instead',
 ...
 'gives you a spooky cookie. It reads “ 2spooky4me” :ghost:',
...
'gives you a cookie fresh from Yvi’s kitchen. It reads “Better be on his good side.”',
